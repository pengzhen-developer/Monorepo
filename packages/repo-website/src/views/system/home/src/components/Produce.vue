<template>
  <div>
    ...
    <div class="banner">
      <el-image :src="require('../assets/images/cp_banner'+url)"
                lazy></el-image>
    </div>
    <div class="sub-menu">
      <div class="main">
        <div class="sub-title">产品/{{title}}</div>
...
import NetHospital from './NetHospital'
...
export default {
  ...
  data() {
    return {
      subMenu: Constant.subMenuPro,
      model: Constant.subMenuPro[0].name
    }
  },
  computed: {
    title() {
