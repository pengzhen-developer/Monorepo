    ...
    <div class="control">
      <el-form inline
        ...
        <el-form-item label="所属辖区"
                      required>
          <region-selector :defaultArea="detail.area"
...
<script>
import { TMap } from '@src/util/modules/TMap'
import { filterRegion } from '@src/util/modules/util'
...
.info-row {
  ...
  &.two-cols {
    .info-row-content {
      width: calc(50% - 3.2em - 4.3em - 0.7em);
    }
  }
}
.el-form-item {
