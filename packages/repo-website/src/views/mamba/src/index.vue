        ...
        <div id="heroCarousel"
          ...
          <div class="carousel-inner"
            ...
            <div class="carousel-item active"
                 v-bind:style="{ 'background-image': `url(${require('./assets/img/slide/slide-1.jpg')})` }">
            ...
            <div class="carousel-item"
                 v-bind:style="{ 'background-image': `url(${require('./assets/img/slide/slide-2.jpg')})` }">
              <div class="carousel-container">
                <div class="carousel-content container">
            ...
            <!-- Slide 3 -->
            <div class="carousel-item"
                 v-bind:style="{ 'background-image': `url(${require('./assets/img/slide/slide-3.jpg')})` }">
              <div class="carousel-container">
                <div class="carousel-content container">
          ...
          <a class="carousel-control-prev"
             ...
             role="button"
             data-slide="prev">
            <span class="carousel-control-prev-icon icofont-rounded-left"
          ...
          <a class="carousel-control-next"
             ...
             role="button"
             data-slide="next">
            <span class="carousel-control-next-icon icofont-rounded-right"
                  aria-hidden="true"></span>
