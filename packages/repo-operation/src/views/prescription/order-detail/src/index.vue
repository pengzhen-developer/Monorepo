        ...
        <div class="row">
          ...
          <div class="col-4">
            ...
            <span class="text-grey-6"
                  v-if="data.SbDetails.length > 0 ">-￥{{ data.SbDetails.reduce((accumulator, currentValue) => accumulator + currentValue.Amount ,0) | formatCurrency }}</span>
            <span class="text-grey-6"
                  v-else>
              --
            </span>
          ...
          <div class="col-4">
            ...
            <span>：</span>
            <span class="text-grey-6"
                  v-if="data.YbDetails.length > 0 ">-￥{{ data.YbDetails.reduce((accumulator, currentValue) => accumulator + currentValue.Amount ,0) | formatCurrency }}</span>
            <span class="text-grey-6"
                  v-else>
              --
            </span>
