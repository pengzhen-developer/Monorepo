<template>
  <div class="card-style q-pa-md">
    <div class="row items-center">
      ...
      <el-button size="small" type="primary" @click="showDataScreen" plain>查看数据大屏</el-button>
    </div>
    <div class="container">
      <div class="data-item" v-for="item in list" v-bind:key="item.id">
        <el-image class="image q-mr-md" v-bind:src="item.icon"> </el-image>
        <div>
