<template>
  <div class="el-form">
    <div
      :class="[ formSize ? 'el-form-item--' + formSize : '',
      !defaultText ? 'mb-none' : '' ]"
      class="el-form-item"
    >
      <label class="el-form-item__label" v-if="provinceText">{{ provinceText }}</label>
      <div :class="{ 'full-width': !provinceText }" class="el-form-item__content">
        <el-select
          :clearable="clearable"
          :disabled="disabled"
    ...
    <div
      ...
      class="el-form-item"
    >
      <label class="el-form-item__label" v-if="cityText">{{ cityText }}</label>
      <div :class="{ 'full-width': !cityText }" class="el-form-item__content">
        <el-select
          :clearable="clearable"
          :disabled="disabled"
    ...
    >
      <label class="el-form-item__label" v-if="areaText">{{ areaText }}</label>
      <div :class="{ 'full-width': !areaText }" class="el-form-item__content">
        <el-select
          :clearable="clearable"
          :disabled="disabled"
          @change="getArea(area)"
...
export default {
  ...
  methods: {
    async init() {
      ...
      this.province = this.selected ? this.defaultProvince : ""
      this.city = this.selected ? this.defaultCity : ""
      this.area = this.selected ? this.defaultArea : ""
