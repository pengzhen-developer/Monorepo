              ...
              <el-form-item label="详细地址"
                ...
                <div class="inline-form"
                  ...
                  <el-form-item class="inline-item"
                                label-width="0px"
                                prop="district">
                    <region-selector :defaultArea="model.district"
...
export default {
  ...
  computed: {
    showRegion() {
      return (
        (this.model.role === CONSTANT.ENUM_ORGANIZATION_TYPE.医疗机构 && this.model.province && this.model.city && this.model.district) ||
