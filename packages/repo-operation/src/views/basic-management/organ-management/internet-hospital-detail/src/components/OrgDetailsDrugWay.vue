  ...
  <div class="layout-route">
      ...
      <el-form v-bind:model="model"
        ...
        <el-form-item label="给药途径">
          <el-input v-model.trim="model.drugtimes_name"
                    placeholder="请输入给药途径名称"></el-input>
        </el-form-item>
    ...
    <div>
      ...
      <PeaceTable ref="table"
        ...
        <PeaceTableColumn label="英文缩写"
                          prop="simple_ename"></PeaceTableColumn>
      </PeaceTable>
    </div>
      ...
      <div>
        <el-form label-width="90px"
          ...
          <el-form-item label="英文缩写">
            <el-input v-model="simpleEname"></el-input>
          </el-form-item>
        </el-form>
...
export default {
  ...
  methods: {
    // 获取给药途径列表
    getList() {
      const fetch = Service.getDrugWayList
    ...
    // 获取给药途径库
    getAllWay() {
      Service.getAllDrugWay().then((res) => {
        const data = res.data
    ...
    setAbbreviation(item) {
      ...
      this.simpleEname = item.abbreviation
    },
    // 打开新增 Dialog
    openDialog() {
    ...
    added(close) {
      ...
      const ename = this.simpleEname

      Service.addDrugWay({ netHospital_id: id, drugway_name: name, simple_cname: cname, simple_ename: ename }).then(
        (res) => {
          const msg = res.msg
          this.getList()
