...
export default {
  ...
  methods: {
    ...
    serviceDetail(params) {
      const configMap = [
        { serviceName: '互联网医院管理端', serviceType: 1, tagName: 'InternetHospitalDetail' },
        { serviceName: '处方管理医院端', serviceType: 3, tagName: 'PrescriptionSharingServiceDetail' },
        { serviceName: '合理用药管理', serviceType: 2, tagName: 'RationalDrugUseManagementDetail' },
        { serviceName: '药品供应管理端', serviceType: 4, tagName: 'DrugSupplyServiceDetail' }
      ]
      ...
      switch (params.serviceType) {
        case 1:
          Peace.cache.sessionStorage.set('196-hospitalId', params.hospitalId)
          this.addTab(tab)
          break
        case 2:
          Peace.cache.sessionStorage.set('197-custCode', params.custCode)
          Peace.cache.sessionStorage.set('197-hospitalName', params.hospitalName)
