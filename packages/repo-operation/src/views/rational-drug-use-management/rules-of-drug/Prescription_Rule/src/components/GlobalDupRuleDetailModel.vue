  ...
  <div>
    <el-form ref="ruleForm"
      ...
      <el-form-item label="成分/成分类别">
        <div class="content-style">{{ruleInfo.dupItemInfos}}</div>
      </el-form-item>
      <el-form-item label="重复的成分/成分类别">
        <div class="content-style">{{ruleInfo.dupContraryInfos}}</div>
      </el-form-item>
...
export default {
  ...
  methods: {
    getDupRuleInfoById() {
      ...
      Service.getDupRuleInfoById(params).then((res) => {
