  ...
  <div class="file">
    ...
    <template v-else>
      ...
      <div class="file-famliy">
        ...
        >
          <van-swipe-item v-for="item in myFamilyList" :key="item.id">
            <div class="file-famliy-swiper-item">
              <div class="header flex between">
                <div class="flex center">
                  ...
                  <van-tag color="#F2F2F2" text-color="#999999">{{
                    item.relation
                  }}</van-tag>
                </div>
                <van-image
              ...
              <div class="content" @click="util.goHealthDetail(item)">
                <h4>健康信息</h4>
                <div class="flex between">
                  <van-progress
                    style="display: inline-block; width: 190px; margin: 0 10px 0 0;background: #eee;"
                    color="#5B9EFF"
  ...
  methods: {
    ...
    changeSwipeTrack(index) {
      if (this.$refs.swipe) {
        ...
        const $swipe__track = this.$refs.swipe.$el.querySelector(
          ".van-swipe__track"
        );
        $swipe__track.style.transform = `translateX(${-this.swipeWidth * index +
          tempWidth}px)`;
      }
    },
    isIphoneX() {
