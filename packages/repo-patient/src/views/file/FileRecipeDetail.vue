    ...
    <template v-else>
      ...
      <div class="row">
        ...
        <div class="row-body"
          ...
          <div>
            <span style="font-size: 13px; color: #999;">{{ item.drugUse }}</span>
          </div>
        </div>
      </div>
      ...
      <div class="row"
        ...
        <div class="flex between"
          ...
          <div style="flex: 1;">
            <span style="font-size: 13px; color: #999;">医 师：</span>
            <span>{{ data.list[current].psychiatric }}</span>
          </div>
          <div style="flex: 1;">
            <span style="font-size: 13px; color: #999;">审核药师：</span>
            <span>{{ data.list[current].prescriptionPharmacistName }}</span>
          </div>
        </div>
        <div class="flex between">
          <div style="flex: 1;">
            <span style="font-size: 13px; color: #999;">调配药师：</span>
            <span>{{ data.list[current].disPharmacist }}</span>
          </div>
          <div style="flex: 1;">
            <span style="font-size: 13px; color: #999;">发药药师：</span>
