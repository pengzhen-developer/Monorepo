<template>
    <div>
        ...
        <!--菜单-->
        <div class="block">
            <div v-for="item in module" class="block-items block-transverse-icon" :id="item.id" @click="goMenuPage">
        ...
        <van-cell-group>
            <van-cell icon="friends-o" is-link title="我的家人" value/>
            <van-cell icon="manager-o" is-link title="我的医生" value/>
            <van-cell icon="location-o" is-link title="收货地址" value/>
            <van-cell icon="setting-o" @click="signOut" is-link title="退出登录" value>
