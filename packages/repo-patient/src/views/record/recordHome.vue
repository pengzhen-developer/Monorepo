<template>
    <div class="record">
        <div class="tab">
            <div @click="changeTab({index:0})" data-index="0" :class="['tab-item', page.tabIndex ? '' : 'active']">
                <div class="span">检验</div>
            </div>
            <div @click="changeTab({index:1})" data-index="1" :class="['tab-item', page.tabIndex ? 'active' : '']">
