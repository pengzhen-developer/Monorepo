    ...
    <div class="grid-two">
      <div class="grid-left">
        <div class="bg-card"
          ...
          <div class="txt"
               v-for="(item, index) in Data[0].diseaseLists"
               :key="index">
            {{item.name}}
          </div>
        </div>
      ...
      <div class="grid-right">
        <div class="bg-card"
          ...
          <div class="txt"
               v-for="(item, index) in Data[1].diseaseLists"
               :key="index">
            {{item.name}}
          </div>
        </div>
        <div class="bg-card"
          ...
          <div class="txt"
               v-for="(item, index) in Data[2].diseaseLists"
               :key="index">
            {{item.name}}
          </div>
        </div>
    ...
    <div class="girl-thr"
      ...
      <template v-for="(item,index) in Items">
        <div class="bg-card"
          ...
          <div class="txt"
               v-for="(it, index) in item.diseaseLists"
               :key="index">
            {{it.name}}
          </div>
        </div>
