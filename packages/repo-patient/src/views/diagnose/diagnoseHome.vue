<template>
  <div>
      ...
      <div class="card-body">
        ...
        <div class="block">
          <div class="card-label"
               v-for="item in data.info.recommendDepName"
               :key="item">
            {{item}}
          </div>
        </div>
    ...
    <div class="tab">
      <div :class="['tab-item', checkedData == 'intro' ? 'active' : '']"
           data-id="intro"
           @click="changeTab({id:'intro'})">
        <div class="span">简介</div>
      </div>
      <div :class="['tab-item', checkedData == 'pathogenyDescr' ? 'active' : '']"
           data-id="pathogenyDescr"
           @click="changeTab({id:'pathogenyDescr'})">
        <div class="span">病因</div>
      </div>
      <div :class="['tab-item', checkedData == 'diagnosisDescr' ? 'active' : '']"
           data-id="diagnosisDescr"
           @click="changeTab({id:'diagnosisDescr'})">
        <div class="span">诊断</div>
      </div>
      <div :class="['tab-item', checkedData == 'treatmentDescr' ? 'active' : '']"
           data-id="treatmentDescr"
           @click="changeTab({id:'treatmentDescr'})">
