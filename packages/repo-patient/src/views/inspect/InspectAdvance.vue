  ...
  methods: {
    ...
    submit() {
      ...
      let params = {
        ...
        diseasesCode: this.payType === 'yibaopay' && this.payInfo.medicalTreatmentType === 1 ? this.payInfo.diseasesCode : '',
        diseasesName: this.payType === 'yibaopay' && this.payInfo.medicalTreatmentType === 1 ? this.payInfo.diseasesName : '',
