<template>
  <div class="page"
    ...
    <!-- orderStatus 1：待支付 2：已取消 3：预约成功 4：已完成 -->
    ...
    <div class="page-bottom-h64"
         v-if="model.orderStatus === 3"></div>
    <div class="page-bottom page-bottom-h64"
         v-if="model.orderStatus === 3">
      <div class="pay">
        <div class="pay-item">
        </div>
        <div class="pay-item pay-justify-end">
...
export default {
  ...
  methods: {
    ...
    cancel(type = 'auto') {
      ...
      peace.service.inquiry
        .cancelCheckRegisteringOrder(params)
        .then(() => {
          if (type == 'auto') {
            this.getDetail()
          } else {
