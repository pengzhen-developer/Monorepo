<template>
    <form bindsubmit="submitOrder" report-submit="true">
        <div class="top">
            ...
            <!--tab^content-->
            <div class="content">
                <div class="tab-content" v-if="page.tabIndex == '0'">
                    <div class="addr-tit">取药地址</div>
                    <div class="addr-p">{{order.Detailed}}</div>
                </div>
                <div class="tab-content" v-if="page.tabIndex == '1'">
                    <div class="addr-tit">我的地址</div>
                    <div v-if="userAddr && userAddr.detailAddress" bindtap="goUserAddrPage" class="userAddr icon-next">
                    ...
                    <div v-else>
                        <div class="block" bindtap="goUserAddrPage">
        ...
        <div class="module">
            <div class="panel-pha">
                <div class="panel-head icon-next" bindtap="goDrugPhaHomePage">
                    <div class="head-ico">
                ...
                <div class="panel-body">
                    <div class="list-three" v-for="item in order.OrderDet">
                        ...
                        <div class="list-other">
                            <div class="other-them"  bindtap="goInterDrugPage">说明书</div>
                    ...
                    <div class="module">
                        ...
                        <div class="dl-packet" v-if="page.tabIndex == '1'">
                    ...
                    <div class="bottom">
                        ...
                        <button form-type="submit" @click="submitOrder" :class="page.canSubmit ? 'btn block btn-blue' : 'btn block btn-default'">提交订单</button>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            canSubmitProcesses () {
                let bool = false, userAddr = this.userAddr;
