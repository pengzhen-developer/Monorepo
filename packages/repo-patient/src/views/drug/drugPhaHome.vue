    ...
    <div class="module">
        <div class="form-dl">
            <div class="form-dt w">营业执照：
                <div class="box-img" @click="preview(phaInfo.BusinessLicenseImage)">
        ...
        <div class="form-dl">
            <div class="form-dt w">药品经营许可证：
                <div class="box-img" @click="preview(phaInfo.PermitImage)">
...
export default {
  ...
  mounted() {
    ...
    this.getDrugStoreApi(params.AccessCode,params.DrugStoreId)
  },
  methods:{
    getDrugStoreApi(AccessCode,DrugStoreId) {
      peace.service.patient.getDrugStoreApi(AccessCode,DrugStoreId).then(res => {
