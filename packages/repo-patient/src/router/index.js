  ...
  routes: [
    {
      ...
      children: [
        ...
        // 医院科室二联动
        {
          ...
          component: () =>
            import("@src/views/hospital/depart/hospitalDepartSelect.vue")
        },
        // 预约挂号医生列表
        {
          ...
          component: () =>
            import("@src/views/appoint/doctor/appointDoctorList.vue")
        },
        {
          ...
          component: () =>
            import("@src/views/hospital/depart/HospitalDepartList.vue")
        },
        {
          ...
          component: () =>
            import("@src/views/appoint/doctor/appointDoctorSelect.vue")
        },
        {
          ...
          component: () =>
            import("@src/views/appoint/order/appointOrderSubmit.vue")
        },
        {
        ...
        },
        {
          ...
          component: () =>
            import("@src/views/setting/order/userOrderDetail.vue")
        },
        {
        ...
        },
        {
          ...
          component: () =>
            import("@src/views/diagnose/select/diagnoseSelectBody.vue")
        },
        {
        ...
        },
        {
          ...
          component: () =>
            import("@src/views/diagnose/select/diagnoseSelectHumen.vue")
        },
        {
