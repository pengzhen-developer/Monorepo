 ...
 * @Last Modified time: 2019-04-10 09:26:29
 */
...
/**
 * 非空验证 正则验证
 * e.g. $peace.valid.isEmpty('http://192.168.0.254/1.json') => false
 * @export
 * @param {*} param
 * @returns
 */
...
/**
 * 长度 正则验证
 * e.g. $peace.valid.length('http://192.168.0.254/1.json', 30) => true
 * @export
 * @param {*} param
 * @param {*} length
 * @returns
...
/**
 * 长度 正则验证（1个双字节=3个单字节）
 * e.g. $peace.valid.lengthForByte('你好1',4) => false
 * @export
 * @param {*} param
 * @param {*} length
 * @returns
...
/**
 * 区间 正则验证
 * e.g. $peace.valid.range('36.5', 1, 100) => false
 * @export
 * @param {*} param
 * @param {*} iMin
 * @param {*} iMax
...
/**
 * url 正则验证
 * e.g. $peace.valid.url('http://192.168.0.254/1.json') => true
 * @export
 * @param {*} param
 * @returns
 */
...
/**
 * 数字 正则验证（正负整数）
 * e.g. $peace.valid.number(123) => true
 * @export
 * @param {*} param
 * @returns
 */
...
/**
 * 整数 正则验证
 * e.g. $peace.valid.integer(-123) => true
 * @export
 * @param {*} param
 * @returns
 */
...
/**
 * 正整数及0 正则验证
 * e.g. $peace.valid.pInterger(123) => true
 * @export
 * @param {*} param
 * @returns
 */
...
/**
 * 负整数及0 正则验证
 * e.g. $peace.valid.nInterger(-123) => true
 * @export
 * @param {*} param
 * @returns
 */
...
/**
 * 手机号码 正则验证
 * e.g. $peace.valid.mobile('13011111111') => true
 * @export
 * @param {*} param
 * @returns
 */
...
/**
 * 身份证 正则验证
 * e.g. $peace.valid.idCard('400210188801011010') => true
 * @export
 * @param {*} param
 * @returns
 */
...
/**
 * 邮箱 正则验证
 * e.g. $peace.valid.email('aa@qq.com') => true
 * @export
 * @param {*} param
 * @returns
 */
