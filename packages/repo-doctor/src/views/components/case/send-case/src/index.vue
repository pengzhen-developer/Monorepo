...
import QuickSelectDiagnoseHistory from '@src/views/components/quick-select/quick-select-diagnose-history/src/index.vue'
...
export default {
  ...
  watch: {
    blood_pressure_begin() {
      if (this.blood_pressure_begin && this.blood_pressure_end) {
  ...
  methods: {
    getTemplate() {
      Service.getRecordTemplate().then((res) => {
