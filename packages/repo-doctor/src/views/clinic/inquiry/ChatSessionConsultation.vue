      ...
      <peace-table pagination ref="table">
        <peace-table-column label="医生头像" prop="name" width="100px">
          <template slot-scope="scope">
            <img :src="scope.row.avartor" style="width: 40px; height: 40px; border-radius: 50%;">
          </template>
        </peace-table-column>
        <peace-table-column align="left" header-align="left" label="医生姓名" prop="doctorName" width="100px"></peace-table-column>
        <peace-table-column align="left" header-align="left" label="职称" prop="doctorTitle" width="100px"></peace-table-column>
        <peace-table-column label="科室" prop="deptName" width="100px"></peace-table-column>
        <peace-table-column align="left" header-align="left" label="医院" prop="hospitalName"></peace-table-column>
      ...
      this.$refs.form.validate(valid => {
        if (valid) {
          ...
          // 开始会诊
            ...
            const params = {
              sourceInquiryNo: this.chat.session.lastMsg.custom.ext.inquiryNo,
              sourcePatientId: this.chat.session.lastMsg.custom.patients.patientId,
              sourceFamilyId: this.chat.session.lastMsg.custom.patients.familyId,
            ...
            this.$http.post(this.config.api.doConsultationApply, params).then(() => {
              const redirect = () => {
                this.$msgbox.close()
