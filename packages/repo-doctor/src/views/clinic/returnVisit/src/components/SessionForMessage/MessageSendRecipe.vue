<template>
  <div>
    ...
    <div class="perscription">
      ...
      <MessageSendRecipeDrugSelect ref="drugSelect"
                                   v-bind:max-count="5"></MessageSendRecipeDrugSelect>
...
<script>
import MessageSendRecipeDrugSelect from './MessageSendRecipeDrugSelect'
import peace from '@src/library'

export default {
  components: {
    MessageSendRecipeDrugSelect
  },
