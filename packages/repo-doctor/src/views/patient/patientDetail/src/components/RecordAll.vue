            ...
            <el-row :gutter="15" type="flex" style="flex-wrap: wrap;">
              <el-col :key="healthItem.id" :span="8" v-for="healthItem in health.list">
                ...
                <template v-else-if="healthItem.healthType === Peace.type.HEALTH.HEALTH_TYPE.会诊">
                  <div class="time-line-content-card">
                    <RecordConsult :data="healthItem" :type="type"></RecordConsult>
                  </div>
                </template>

                <template v-else-if="healthItem.healthType === Peace.type.HEALTH.HEALTH_TYPE.转诊">
                  <div class="time-line-content-card">
                    <RecordReferral :data="healthItem" :type="type"></RecordReferral>
                  </div>
                </template>
              </el-col>
            </el-row>
            ...
            <el-row :gutter="15" type="flex" style="flex-wrap: wrap;">
              <el-col :key="healthItem.id" :span="8" v-for="healthItem in health.list">
                <template v-if="healthItem.checkType === Peace.type.HEALTH.CHECK_TYPE.检验">
                  <div class="time-line-content-card">
                    <RecordInspection :data="healthItem" :type="type"></RecordInspection>
                  </div>
                </template>

                <template v-if="healthItem.checkType === Peace.type.HEALTH.CHECK_TYPE.影像">
                  <div class="time-line-content-card">
                    <RecordPACS :data="healthItem" :type="type"></RecordPACS>
                  </div>
                </template>
              </el-col>
            </el-row>
            ...
            <el-row :gutter="15" type="flex" style="flex-wrap: wrap;">
              <el-col :key="healthItem.id" :span="8" v-for="healthItem in health.list">
                ...
                <template v-if="healthItem.healthType === Peace.type.HEALTH.HEALTH_TYPE.诊疗记录">
                  <div class="time-line-content-card">
                    <RecordFirstOption :data="healthItem" :type="type"></RecordFirstOption>
                  </div>
                </template>
              </el-col>
            </el-row>
