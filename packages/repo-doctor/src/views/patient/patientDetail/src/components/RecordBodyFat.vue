...
export default {
  ...
  methods: {
    ...
    showReport() {
      ...
      const serviceId = Type.HEALTH.SERVICE_ID.无
      const type = Type.HEALTH.TYPE.体脂
...
.record-body-fat {
  ...
  .type-daily {
    ...
    background-image: url('~@src/assets/images/health-record/bg_body fat.png');
