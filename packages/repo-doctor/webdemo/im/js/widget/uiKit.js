		...
		if (sessions.length === 0) {
			...
			for (i = 0;i<sessions.length;i++) {
                ...
                str = ['<li class="panel_item '+(info.crtSession===info.target?'active':'')+'" data-scene="' + info.scene + '" data-account="' + info.account + '">',
                    ...
                    '<div class="panel_text">',
                    '<p class="panel_multi-row">',
                    '<span class="panel_nick font-style">' +info.nick + '</span>',
                    info.unread ? '<sup class="tip-unread">' + info.unread + '</sup>':'',
                    '<span class="panel_nick">男</span>',
                    '<span class="panel_nick">27岁</span>',
                    /*'<b class="panel_time">' + info.time + '</b>',*/
                    '<b class="panel_time">待接诊</b>',
                    '</p>',
                    '<p class="panel_multi-row">',
                    '<span class="panel_lastMsg">' + info.text + '</span>',
                    /*info.unread ? '<b class="panel_count">' + info.unread + '</b>':'',*/
                    '</p>',
					'<p class="list-p-3"><img class="img-left-list" src="images/chat_icon_pic.png">图文咨询<b>' + info.time + '</b></p>',
                    '</div>',
                    '</li>'].join("");
                html += str;
			}    
