...
function buildSessionMsg(msg) {
    ...
    var sentStr = (msg.from!==userUID)?"收到":"发送";
    ...
    switch (msg.type) {
        ...
        case 'custom':
            ...
            if(content.type===1){
                ...
                str = `<a class="imgtxt" onclick='DataDetails("${obj.caseId}")'>`;
                str += `<div class="imgtxt-title"><img src="./images/ic_medicalrecord.png"></div>`;
                str += `<div class="imgtxt-title2"><h5>病历</h5><p>查看详情</p></div>`;
                str += `</a>`;
            }else{
                str = sentStr+'一条[自定义]消息，请到手机或电脑客户端查看';
            }
