...
var yunXin = {
    ...
    addEvent: function () {
        ...
        this.$sendRecord.on('click', this.sendCustomMessage.bind(this,this.$sendRecord));
    ...
    uploadFile: function (e) {
        ...
        var file =  document.getElementById("j-uploadFile").files[0];
        data.append("file",file);
        data.append("id","yfqdpetnch");
        data.append("cid","ewrwerdfvs");
        data.append("pid","nzrwejdcoe");
        console.log(data);
        $.ajax({
            type:"post",
            url: "http://www.api.com/doctorapi/Im/sendImgMsg",
            contentType:false,
            data: data,
            processData:false,
       ...
       /* var formData = new FormData();
        ...
        $.ajax({
            url: 'http://www.apiserver.com/doctorapi/index/upload',
            type: 'post',
            cache: false,
            data: formData,
            processData: false,
    ...
    sendTextMessage: function () {
        ...
        if ( !! to && !! text) {
           if (text.length > 500) {
               ...
               $.ajax({
                   type: 'post',
                   url: "http://www.api.com/doctorapi/Im/sendContentMsg",
                   data: {
                       id: "yfqdpetnch",
                       cid: "ewrwerdfvs",
                       pid: "nzrwejdcoe",
    ...
    /*自定义消息*/
    sendCustomMessage:function (that) {
        ...
        $.ajax({
            type: 'post',
            url: "http://www.api.com/doctorapi/Im/sendCaseMsg",
            data: {
                id: "yfqdpetnch",
                cid: "ewrwerdfvs",
                pid: "nzrwejdcoe",
