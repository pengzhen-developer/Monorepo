  ...
  <div class="imports">
    ...
    <el-form label-width="auto"
      ...
      <el-form-item class="step">
        <Steps v-bind:list='stepsData.stepsList'
...
export default {
  ...
  watch: {
    stepsList: {
      handler() {
        if (Array.isArray(this.stepsList) && this.stepsList.length == 3) {
          this.stepsData.stepsList = Object.assign([], this.stepsList)
        }
      },
      immediate: true
    },
  ...
  methods: {
    ...
    onSuccess(res) {
      ...
      if (res.code === 200) {
        ...
        this.successTipText = res.message || res.msg
      } else {
        this.stepsData.active = 1
        this.errorTipText = res.message || res.msg
