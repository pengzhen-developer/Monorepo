  ...
  <div>
    <PeaceDialog title="添加条件"
      ...
      <peace-table ref="table"
        ...
        <peace-table-column label="人群编码"
                            min-width="120px"
                            prop="code">
        </peace-table-column>
        <peace-table-column label="人群分类名称"
                            min-width="120px"
                            prop="name">
        </peace-table-column>
        ...
        <peace-table-column label="平台人群名称"
                            min-width="120px"
                            prop="platformClassName">
          <template slot-scope="scope">
...
export default {
  ...
  methods: {
    fetch() {
      const fetch = Service.getOrgHumanClass
      const params = {
