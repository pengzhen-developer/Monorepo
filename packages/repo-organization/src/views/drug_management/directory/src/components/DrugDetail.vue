  ...
  <div>
    <el-form :model="drug"
      ...
      <el-form-item label="药品编号："
                    prop="CustDrugsCode">
        <el-input v-model="drug.CustDrugsCode"
                  maxlength="20"
                  placeholder="请输入药品编号"></el-input>
      </el-form-item>
      <el-form-item label="药品名称："
                    prop="ProductName">
        <el-input v-model="drug.ProductName"
                  placeholder="请输入药品名称"></el-input>
      </el-form-item>
      <el-form-item label="药品规格："
                    prop="DrugSpecifications">
        <el-input v-model="drug.DrugSpecifications"
                  placeholder="请输入药品规格"></el-input>
      </el-form-item>
      <el-form-item label="包装单位："
                    prop="PackUnit">
        <el-input v-model="drug.PackUnit"
                  placeholder="请输入包装单位"></el-input>
      </el-form-item>
      <el-form-item label="生产厂家："
                    prop="EnterpriseName">
        <el-input v-model="drug.EnterpriseName"
                  placeholder="请输入生产厂家"></el-input>
      </el-form-item>
      <el-form-item label="批准文号："
                    prop="ApprovalNumber">
        <el-input v-model="drug.ApprovalNumber"
