<template>
  <div class="referral">
    ...
    <div class="referral-info"
         v-if="!(info.transfer_status === 7 && info.in_examine_opinion.transfer_status === '待审核')">
      <div class="info-title">转入机构审核信息</div>
      <template v-if="info.transfer_status !== 7 && info.in_examine_opinion.transfer_status === '待审核'">
        <div class="info-row">
          <div class="info-row-label">
            <span>审核结果</span>
          </div>
...
const REFERRAL_IN_IMAGE_MAP = {
  1: require('@src/views/internet-cloud-hospital/referral-center/referral-in/src/assets/images/1.png'),
  2: require('@src/views/internet-cloud-hospital/referral-center/referral-in/src/assets/images/2.png'),
  3: require('@src/views/internet-cloud-hospital/referral-center/referral-in/src/assets/images/3.png'),
  4: require('@src/views/internet-cloud-hospital/referral-center/referral-in/src/assets/images/4.png'),
  5: require('@src/views/internet-cloud-hospital/referral-center/referral-in/src/assets/images/5.png'),
  6: require('@src/views/internet-cloud-hospital/referral-center/referral-in/src/assets/images/6.png'),
  7: require('@src/views/internet-cloud-hospital/referral-center/referral-in/src/assets/images/7.png')
}
...
export default {
  ...
  computed: {
    imgSrc() {
      return REFERRAL_IN_IMAGE_MAP[this.info.transfer_status]
    }
  },
  methods: {
    submitExamine() {
