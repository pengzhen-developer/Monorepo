...
const REFERRAL_OUT_IMAGE_MAP = {
  1: require('../assets/images/referral/1.png'),
  2: require('../assets/images/referral/2.png'),
  3: require('../assets/images/referral/3.png'),
  4: require('../assets/images/referral/4.png'),
  5: require('../assets/images/referral/5.png'),
  6: require('../assets/images/referral/6.png'),
  7: require('../assets/images/referral/7.png')
}
